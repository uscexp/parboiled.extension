 ...
 */
package com.github.uscexp.parboiled.extension.codegenerator.parser;
...
public class GeneratorTestCalculatorParser extends BaseParser<Double> {
	...
	@AstCommand(classname = "com.github.uscexp.parboiled.extension.codegenerator.parser.AstResultTreeNode")
